...
namespace Cyxor.Serialization
{
    public class JsonBackingSerializer : IBackingSerializer
    {
        ...
        {
            var jsonSerializerOptions = backingSerializerOptions == null ? default : IBackingSerializer.ValidateOptions<JsonSerializerOptions>(backingSerializerOptions);
        ...
        public T Deserialize<T>(Serializer serialStream, object? backingSerializerOptions)
        {
            ...
            var utf8JsonReader = new Utf8JsonReader(serialStream.AsReadOnlySpan<byte>(serialStream.Int32Position, serialStream.Int32Length - serialStream.Int32Position));
