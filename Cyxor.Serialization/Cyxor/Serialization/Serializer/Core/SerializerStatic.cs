...
namespace Cyxor.Serialization
{
    ...
    partial class Serializer
    {
        ...
        {
            public static readonly SerializeUnmanaged<T> SerializeUnmanagedDelegate = (SerializeUnmanaged<T>)SerializeUnmanagedInfo.Method.CreateDelegate(typeof(SerializeUnmanaged<T>));
        }
        ...
        static readonly (Type Type, MethodInfo Method) SerializeEnumInfo = SerializerMethods.Where(p => p.GetCustomAttribute<SerializerMethodIdentifierAttribute>()?.Identifier == SerializerMethodIdentifier.SerializeEnum).Select(p => (typeof(Enum), p)).Single();

        static readonly (Type Type, MethodInfo Method) DeserializeEnumInfo = SerializerMethods.Where(p => p.GetCustomAttribute<SerializerMethodIdentifierAttribute>()?.Identifier == SerializerMethodIdentifier.DeserializeEnum).Select(p => (typeof(Enum), p)).Single();

        static readonly (Type Type, MethodInfo Method) SerializeUnmanagedInfo = SerializerMethods.Where(p => p.GetCustomAttribute<SerializerMethodIdentifierAttribute>()?.Identifier == SerializerMethodIdentifier.SerializeUnmanaged).Select(p => (typeof(Utilities.Unmanaged), p)).Single();

        static readonly (Type Type, MethodInfo Method) DeserializeUnmanagedInfo = SerializerMethods.Where(p => p.GetCustomAttribute<SerializerMethodIdentifierAttribute>()?.Identifier == SerializerMethodIdentifier.DeserializeUnmanaged).Select(p => (typeof(Utilities.Unmanaged), p)).Single();
