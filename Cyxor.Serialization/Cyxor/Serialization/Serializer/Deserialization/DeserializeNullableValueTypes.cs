...
namespace Cyxor.Serialization
{
    partial class Serializer
    {
        ...
        T? DeserializeNullableUnmanaged<T>(DeserializeSignature<T> deserializeDelegate) where T : struct
            => !DeserializeBoolean() ? default(T?) : deserializeDelegate();

        delegate T DeserializeSignatureLittleEndian<T>(bool littleEndian);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        T? DeserializeNullableUnmanaged<T>(bool littleEndian, DeserializeSignatureLittleEndian<T> deserializeDelegate) where T : struct
        ...
        public char? DeserializeNullableChar()
            => DeserializeNullableUnmanaged(DeserializeChar);

        public float? DeserializeNullableSingle()
            => DeserializeNullableUnmanaged(DeserializeSingle);

        public double? DeserializeNullableDouble()
            => DeserializeNullableUnmanaged(DeserializeDouble);

        public byte? DeserializeNullableByte()
            => DeserializeNullableUnmanaged(DeserializeByte);

        public sbyte? DeserializeNullableSByte()
            => DeserializeNullableUnmanaged(DeserializeSByte);

        public short? DeserializeNullableInt16()
            => DeserializeNullableUnmanaged(DeserializeInt16);
        ...
        public ushort? DeserializeNullableUInt16()
            => DeserializeNullableUnmanaged(DeserializeUInt16);
        ...
        public int? DeserializeNullableInt32()
            => DeserializeNullableUnmanaged(DeserializeInt32);
        ...
        public uint? DeserializeNullableUInt32()
            => DeserializeNullableUnmanaged(DeserializeUInt32);
        ...
        public long? DeserializeNullableInt64()
            => DeserializeNullableUnmanaged(DeserializeInt64);
        ...
        public ulong? DeserializeNullableUInt64()
            => DeserializeNullableUnmanaged(DeserializeUInt64);
        ...
        public decimal? DeserializeNullableDecimal()
            => DeserializeNullableUnmanaged(DeserializeDecimal);
        ...
        public Guid? DeserializeNullableGuid()
            => DeserializeNullableUnmanaged(DeserializeGuid);

        public TimeSpan? DeserializeNullableTimeSpan()
            => DeserializeNullableUnmanaged(DeserializeTimeSpan);

        public DateTime? DeserializeNullableDateTime()
            => DeserializeNullableUnmanaged(DeserializeDateTime);

        public DateTimeOffset? DeserializeNullableDateTimeOffset()
            => DeserializeNullableUnmanaged(DeserializeDateTimeOffset);

        public BigInteger? DeserializeNullableBigInteger()
            => DeserializeNullableUnmanaged(DeserializeBigInteger);

        public T? DeserializeNullableEnum<T>() where T : unmanaged, Enum
            => DeserializeNullableUnmanaged(DeserializeEnum<T>);

        public T? DeserializeNullableUnmanaged<T>() where T : unmanaged
            => DeserializeNullableUnmanaged(DeserializeUnmanaged<T>);

        public T? DeserializeNullableValue<T>() where T : struct
            => DeserializeNullableUnmanaged(DeserializeObject<T>);
        ...
        bool TryDeserializeNullableUnmanaged<T>(out T? value, TryDeserializeSignature<T> tryDeserializeDelegate) where T : struct
        {
            bool result;
            value = default;
        ...
        bool TryDeserializeNullableUnmanaged<T>(out T? value, bool littleEndian, TryDeserializeSignatureLittleEndian<T> tryDeserializeDelegate) where T : struct
        {
            bool result;
            value = default;
        ...
        public bool TryDeserializeNullableEnum<T>(out T? value) where T : unmanaged, Enum
            => TryDeserializeNullableUnmanaged(out value, TryDeserializeEnum);

        public bool TryDeserializeNullableUnmanaged<T>(out T? value) where T : unmanaged
            => TryDeserializeNullableUnmanaged(out value, TryDeserializeUnmanaged);

        public bool TryDeserializeNullableValue<T>(out T? value) where T : struct
            => TryDeserializeNullableUnmanaged(out value, TryDeserializeObject);
