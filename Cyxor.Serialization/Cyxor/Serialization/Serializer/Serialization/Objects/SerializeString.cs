...
partial class Serializer
{
    ...
    public void Serialize(string value, int start) => InternalSerialize(value.AsSpan(start), raw: false);
    ...
    public void SerializeRaw(string value, int start) => InternalSerialize(value.AsSpan(start), raw: true);
